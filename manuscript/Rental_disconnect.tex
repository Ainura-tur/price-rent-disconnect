...
sample, namely a migration-to-completions tightness measure, wage growth, and
...
into prices on impact and reaches rents with a delay, with the
preferred specification showing little rent response during the first
year and a gradual build-up thereafter, so the two responses converge
...
conditions. The strengthening of the price--investor-credit channel is
broad-based across all five capitals rather than concentrated in any
single city. We interpret the breakdown of the
